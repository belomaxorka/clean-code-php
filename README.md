...
Нулевое объединения - это новый оператор, [введенный в PHP 7](https://www.php.net/manual/ru/migration70.new-features.php#migration70.new-features.null-coalesce-op).
