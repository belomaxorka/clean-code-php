...
## Содержание
  ...
  2. [Переменные](#Переменные)
     ...
     * [Используйте одно и то же название для переменных с одинаковым назначением](#Используйте-одно-и-тоже-название-для-переменных-с-одинаковым-назначением)
...
Вы можете использовать [контроль типов](https://www.php.net/manual/ru/language.types.declarations.php) и быть уверенным, что переменная `$breweryName` никогда не будет `NULL`.
